		...
		commands: {
			...
			applyHeadingPreset: {
				...
				exec: function ( editor, value ) { // eslint-disable-line max-statements
					...
					// However, there's no style with name `clear`. And we falling back to the default style
					// We just don't need to reapplyStyle for `clear` because proper styles already there.
					if (value !== "clear") {
