...
(function () {
    CKEDITOR.plugins.add('pstatenterkey', {
    ...
    CKEDITOR.plugins.pstatenterkey = {
        enterBlock: function (editor, mode, range, forceMode) {
            ...
            if (atBlockStart && atBlockEnd) {
                ...
                if (block && ( block.is('li') || block.getParent().is('li') )) {
                    ...
                    if (blockGrandParent.is('li')) {
                        ...
                        // before the parent list if block is first child and within
                        ...
                        if (firstChild || lastChild) {
                            ...
                            if (lastChild) {
                                blockGrandParent.appendBogus();
                                range.moveToElementEditEnd(blockGrandParent);
                                range.select();
                                block.remove();
                                return;
                            } else {
                                block.insertBefore(blockGrandParent);
                            }
            ...
            if (previousBlock && previousBlock.is('li') && previousBlock.getLast().type == CKEDITOR.NODE_ELEMENT && previousBlock.getLast().is('br')) {
                previousBlock.getLast().remove();
            }
    ...
    var plugin = CKEDITOR.plugins.pstatenterkey,
    ...
    function enter(editor, mode, forceMode) {
        ...
        var lastElementName = path.lastElement.getName();
